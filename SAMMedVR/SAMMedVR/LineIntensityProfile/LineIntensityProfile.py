...
class LineIntensityProfile(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.title = _("LineIntensityProfile")  # TODO: make this more human readable by adding spaces
...
#
# LineIntensityProfileParameterNode
#
...
class LineIntensityProfileWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setParameterNode(self, inputParameterNode: Optional[LineIntensityProfileParameterNode]) -> None:
        """
...
class LineIntensityProfileLogic(ScriptedLoadableModuleLogic):
    ...
    def getParameterNode(self):
        return LineIntensityProfileParameterNode(super().getParameterNode())
